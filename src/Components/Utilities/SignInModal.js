...
const SignInModal = props => {
    ...
    // useEffect(() => {
    //     // if(location.pathname === '/signup') toggleSignUpDialog();
    //     if(open && location.pathname !== '/signin') handleClose(false);
    //     // return () => {
    //     //     cleanup
    //     // };
    // }, [location]);
    ...
    const toggleDialog = (e) => {
        handleClose(e, match.path+'signup');
    };
        ...
        // ReactDOM.createPortal(
            <Grid item style={{ order: 3 }}>
                ...
                >
                    ...
                    <DialogContent style={{ padding: theme.spacing(0, 1 * 6) }}>
                        ...
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <Box display="flex" justifyContent="flex-start" alignItems="flex-start" flexDirection="column" mb={3}>
                                ...
                                {/* <InputLabel htmlFor="signin-adornment-password">Password</InputLabel> */}
                                {
                                    getFieldDecorator('password', {
                                        ...
                                        <TextField
                                            ...
                                            error={getFieldError("password") && getFieldError("password").length > 0}
                                            helperText={getFieldError("password") && getFieldError("password").length > 0 ? getFieldError("password") : ""}
                                        />
                                    )
                                }
                                {/* {
                                (getFieldError("password") &&
                                    ...
                                    <FormHelperText id="signin-password-error-text">
                                        {getFieldError("password")}
                                    </FormHelperText>)
                                || ''
                            } */}
                            ...
                            <Box display="flex" justifyContent="flex-start" alignItems="center" flexDirection="column" mb={3}>
                                <CustomRouterLink to="/forgotpassword" style={{ textDecoration: 'none', color: 'inherit' }}>
                    ...
                    <DialogActions style={{ backgroundColor: blue['50'] }}>
                        <Box display="flex" justifyContent="center" alignItems="center" flexDirection="column" width="100%" p={theme.spacing(0.3)}>
...
export default createDOMForm({ name: 'signInForm' })(SignInModal);
